...
import { LayoutDashboard, BookOpen, ClipboardList, CreditCard, Receipt, Bell, Calendar, FolderOpen, Menu, X, LogOut, Users } from 'lucide-react';
...
const bottomNavItems = [
  ...
  { label: 'Results', path: '/parent/results', icon: BookOpen },
  { label: 'Fees', path: '/parent/fees', icon: CreditCard },
  { label: 'More', path: '/parent/children', icon: Menu },
];
    ...
    <div className="min-h-screen bg-gray-50 pb-20 lg:pb-0">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50 flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-primary">Parent Portal</span>
        </div>
        ...
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-gray-100">
            <Link to="/parent" className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-primary">Parent Portal</h2>
